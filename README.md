...
| `ARBITRAGE_HEDGE_GRACE_SECS` | `3` | Imbalance window; GTD concurrent orders wait then cancel remainders without auto-unwind, GTC waits in the gated path, FOK/FAK actively re-hedge then unwind |
